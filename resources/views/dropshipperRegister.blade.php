            ...
            <div class="col-md-9 register-right">
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <h3 class="register-heading">Apply as a Dropshipper</h3>
                        ...
                        <form action="{{route('dropRegister', ['id'=> $id ])}}" method="post">
                            @csrf
                            <input type="hidden" name="roles" value="dropshipper" />
                            <div class="row register-form">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    <div class="form-group">
                                        <input type="text" minlength="10" maxlength="10" name="contact" class="form-control" placeholder="Phone number: *" value="" required />
                                    </div>
