                ...
                <div class="row w-100">
                  ...
                  <div class="col-md-9">
                    ...
                    <div class="input-group ">
                      <input type="text" class="form-control" value="https://webcyst.com/ezzyhportal/userform/{{Auth::user()->id}}" id="myInput" style="padding: 7px; font-weight: 800; border: 1px solid #884ffb; color: #884ffb; border-radius: 5px; background: transparent;" readonly="true">
                      <div class="input-group-append">
                      ...
                      <form action="" class="d-flex" style="width: 96%;">
                        ...
                        <div class="col-md-3">
                          {{-- <form id="sortForm" class="mt-3"> --}}
                            <select name="loan_status" id="sort" class="form-control mt-3">
                ...
                <div class="col-md-1" style="margin-left:-10px;">
                  <div class="d-flex">
                    ...
                    <form action="{{route('export')}}" method="get" class="mt-3" >
                      {{-- <a href="{{route('export')}}" class="btn-info btn mt-3">Export</a> --}}
